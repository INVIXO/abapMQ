CLASS zcl_mqtt_packet_pubrec DEFINITION
  PUBLIC
  CREATE PUBLIC .
...
CLASS ZCL_MQTT_PACKET_PUBREC IMPLEMENTATION.
  ...
  METHOD zif_mqtt_packet~get_type.
    ...
    rv_value = zif_mqtt_constants=>gc_packets-pubrec.
